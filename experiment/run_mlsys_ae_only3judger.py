"""
Run Template — copy this file, edit CONFIG, run it.
"""
...
TASKS = [
    # --- small models ---
    dict(
        workload_name="single_turn_3_layers",
    ...
    dict(
        workload_name="single_turn_3_layers",
        target_model="hugging-quants/Meta-Llama-3.1-70B-Instruct-AWQ-INT4",
        benchmark_path="./benchmark/boa_benchmark/jailbreak_oracle_benchmark.json",
        top_p=0.9,
        top_k=-1,
        temperature=0.6,
    ...
    dict(
        workload_name="single_turn_3_layers",
        target_model="Qwen/Qwen2.5-72B-Instruct-AWQ",
        benchmark_path="./benchmark/boa_benchmark/jailbreak_oracle_benchmark.json",
        top_p=0.95,
        top_k=20,
        temperature=0.6,
